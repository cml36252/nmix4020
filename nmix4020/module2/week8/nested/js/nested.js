...
document.querySelector('#asteroid').innerHTML = 'The asteroid named ' + asteroid.name + ' is between ' + asteroid.estimated_diameter.miles.estimated_diameter_min + ' and ' + asteroid.estimated_diameter.miles.estimated_diameter_max + ' miles wide, and will miss striking ' + asteroid.close_approach_data[0].orbiting_body + ' by ' + asteroid.close_approach_data[0].miss_distance.miles + ' miles.<br>'
document.querySelector('#asteroid').innerHTML += '<a href="' + asteroid.nasa_jpl_url + '">More information</a><br>'